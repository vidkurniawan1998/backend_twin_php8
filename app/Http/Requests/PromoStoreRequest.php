...
class PromoStoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'toko'          => 'nullable|array',
            'disc_rupiah_distributor'=> 'numeric|min:0|max:99999999999999999999',
            'disc_rupiah_principal' => 'numeric|min:0|max:99999999999999999999',
            'minimal_order' => 'required|numeric|min:0'
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'disc_rupiah_distributor.numeric' => 'Format diskon tidak valid',
            'disc_rupiah_principal.numeric' => 'Format diskon tidak valid',
            'minimal_order.required' => 'Minimal order harus isi',
            'minimal_order.numeric' => 'Format minimal order tidak valid',
            'minimal_order.min' => 'Minimal order tidak boleh kurang dari 0',
        ];
    }
}
